...
\newcommand{\mainitem}[2]{\item[#1] \tabto{\listtabwidth}#2}
\newcommand{\subitem}[2]{\item[#1] \tabto{\listtabwidth}\hspace{1cm}#2}  % Adds 1cm space before subitem text
...
\begin{document}
    ...
    \begin{tablist}
      ...
      \subitem[Ph.D.] \tab{}Dissertation: Policy, Planning, and Housing Challenges of Asian Americans
