...
\begin{document}
    ...
    \begin{itemize}
      \item Housing Policy, Neighborhood Change, Residential Mobility, Urban Analytics
      \item Ethnic Neighborhoods, Immigration and Cities, Asian Americans
    \end{itemize}
