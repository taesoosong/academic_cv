...
{\begin{list}{}{\setlength{\leftmargin}{0.2em}
...
\begin{document}
    ...
    \begin{tablist}
      ...
      \begin{itemize}
        \item Dissertation: The Role of Policy and Planning in Shaping Asian American Housing Experience
    \end{itemize}
...
\section*{Awards}
  ...
  \subsection*{Membership}
    ...
    \begin{tablist}
        \item[2023-Present] \tab{}Graduate Student Researcher at Terner Center for Housing Innovation, UC Berkeley
        \item[2023-Present] \tab{}Policy Reporter at Seoul Institute
