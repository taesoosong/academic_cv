...
\begin{document}
    ...
    \section*{In Progress}
    \begin{tablist}
        \item[2024] \tab{}\fullcite{ramiller2024}
        \item[2024] \tab{}\fullcite{song_canada}
        \end{tablist}
    
    \section*{Publications}
    \subsection*{Journal Articles}
    \begin{tablist}
        \item[2024] \tab{}\fullcite{song2024}
        \item[2023] \tab{}\fullcite{chapple2024}
        \item[2023] \tab{}\fullcite{lee2022}
        \item[2023] \tab{}\fullcite{lee2021}
        \item[2023] \tab{}\fullcite{song2021}
        \item[2023] \tab{}\fullcite{song2020}
    \end{tablist}
