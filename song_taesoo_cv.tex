...
\usepackage{needspace} % <- only once
...
\setlist[subpoints]{%
  ...
  parsep=0pt,
  partopsep=0pt,
  % Safer needspace in lists: ensure vertical mode first
  before=\begingroup\let\olditem\item \renewcommand{\item}{\par\needspace{3\baselineskip}\olditem},
...
\setlist[subpoints2]{%
  ...
  parsep=0pt,
  partopsep=0pt,
  before=\begingroup\let\olditem\item \renewcommand{\item}{\par\needspace{2.4\baselineskip}\olditem},
  after=\endgroup
}
