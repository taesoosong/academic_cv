...
% Lists & tabbed descriptions (enumitem only; no manual itemize override)
\usepackage{enumitem}
...
% Headings (pinned sizes; zero gap between title and rule)
\usepackage{titlesec}
\SetTracking{encoding=*, family=\sfdefault}{30}
\newcommand{\SectionRule}{\par\noindent\rule{\linewidth}{0.5pt}} % no vspace
\titleformat{\section}
...
% Links: muted color; single hyperref load
\usepackage{xcolor}
