...
\begin{document}
    ...
    \begin{tablist}
      \item[2025] Housing Policy, Neighborhood Change, and Residential Mobility: Novel Methodologies and Insights. \emph{53rd International Conference on Urban Affairs}, Vancouver, BC. Apr. (Scheduled)
    \end{tablist}
