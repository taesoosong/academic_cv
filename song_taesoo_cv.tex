...
\noindent \textbf{Davis, J., \textbf{Song, T.} \& Chapple, K.} How Does Upzoning Impact Residential Mobility Among Low-Income Households? Evidence from New York City.
\begin{itemize}[label=--,leftmargin=2em] % Use hyphens as bullets, adjust left margin for indentation
    \item \emph{53rd International Conference on Urban Affairs}, Vancouver, BC. Apr. 2025 (Scheduled)
\end{itemize}

\noindent \textbf{Reid, C. \& \emph{\textbf{Song, T.}}} Does Apartment Flipping Fuel Residential Displacement? Insights from Assessor and Mobility Data.
...
\noindent \textbf{Ramiller, A., \textbf{Song, T.}, \emph{Parker, M.} \& Chapple, K.} "Measuring Residential Mobility Using Consumer Reference Datasets."
\begin{itemize}[label=--,leftmargin=2em]
    \item \emph{The Association of Collegiate Schools of Planning 64th Annual Conference}, Seattle, WA. Nov. 18, 2024 (Scheduled)
\end{itemize}

\noindent \textbf{Reid, C. \& \textbf{Song, T.}} "Using Residential Mobility Data to Analyze NOAH Displacement."
\begin{itemize}[label=--,leftmargin=2em]
