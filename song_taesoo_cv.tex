...
\begin{document}
    ...
    \begin{itemize}
        ...
        \vspace{-0.6em}
        \item \item[Under Review] \tab{}Ramiller A., \textbf{Song, T.}, Parker, M. \& Chapple, K. "Residential Mobility and Big Data: Assessing the Validity of Consumer Reference Datasets." Under review at \emph{Cityscape}.
      \end{itemize}
        \end{tablist}
