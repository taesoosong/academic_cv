...
\setlist[subpoints]{label={},leftmargin=1.6em,
  itemsep=.45\baselineskip,parsep=0pt,topsep=0pt,partopsep=0pt}

% Dotless second-level details (courses; venues/dates)
\newlist{subpoints2}{itemize}{1}
\setlist[subpoints2]{label={},leftmargin=2.6em,
  itemsep=.18\baselineskip,parsep=0pt,topsep=0pt,partopsep=0pt}
...
\begin{subpoints}
  \item \textbf{City and Regional Planning} — Instructor of Record
    ...
    \end{subpoints2}
  \item \textbf{D Lab} — Workshop Instructor and Assistant Instructor
    \begin{subpoints2}
