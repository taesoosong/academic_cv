...
\usepackage{tabto}
\usepackage{tabularx}
\newcommand{\listtabwidth}{2.0cm} % slightly narrower gutter
...
% Headings (sizes pinned so 11pt body doesn't inflate them)
\usepackage{titlesec}
...
% Links: muted color; single hyperref load (PDF.js-safe)
\usepackage{xcolor}
