...
\newcommand{\beforesubsectionskip}{0.65\baselineskip}
\newcommand{\aftersubsectionskip}{0.18\baselineskip}
\newcommand{\ruleaboveskip}{-0.28\baselineskip}

\newcommand{\SectionRule}{%
  \vspace{\ruleaboveskip}%
  \noindent\rule{\linewidth}{0.5pt}%
}

\titleformat{\section}
  {\sffamily\bfseries\scshape\normalsize}
  {}{0pt}{\MakeUppercase}[\SectionRule]
\titlespacing*{\section}{0pt}{\beforesectionskip}{\aftersectionskip}

\titleformat{\subsection}
  {\sffamily\bfseries\normalsize}
  {}{0pt}{}
\titlespacing*{\subsection}{0pt}{\beforesubsectionskip}{\aftersubsectionskip}
...
\raggedleft
\href{mailto:taesoo@vt.edu}{taesoo@vt.edu}\\
\href{https://taesoosong.github.io}{taesoosong.github.io}\\
\href{https://scholar.google.com/citations?user=2VUTbVcAAAAJ}{Google Scholar}\\
\href{https://github.com/taesoosong}{GitHub}
\end{minipage}
...
\begin{tablist}
  \item[2026--] \tab{}\textbf{Assistant Professor, Virginia Tech}, starting August 2026
  % exact: start=  (tenure clock start; confirm exact date + tenure-review year with dept)
    \begin{subpoints}
      \spitem Urban and Environmental Policy and Planning, School of Public and International Affairs
    \end{subpoints}
\end{tablist}
...
\section{Education}
\begin{tablist}
  \item[Ph.D.] \tab{}\textbf{City and Regional Planning, University of California, Berkeley}, 2026
    \begin{subpoints}
      \spitem Designated Emphasis in Global Metropolitan Studies
      \spitem Dissertation: Housing Stratification Beyond the Black-White Binary: Immigration and Housing in Asian America
...
Asian American Studies & Urban Analytics
\end{tabular}

% ===== Publications =====
\section{Publications}

% ---- Private timeline notes (do NOT render in the PDF) --------------
% Drop exact dates in a "% exact:" comment under each entry.
% NOTE: this repo is PUBLIC, so these comments are visible in the source.
% Keep them to non-sensitive facts (dates, DOIs). Anything private
% (evaluations, candid notes) belongs in a local, gitignored file.
%   Pubs:   % exact: submitted=  accepted=  online=  print=
%   Grants: % exact: awarded=  start=  end=  role=
% --------------------------------------------------------------------

\subsection{Peer-reviewed Journal Articles}
\begin{tablist}
\item[2026] \tab{}Davis, J., \textbf{Song, T.}, \& Chapple, K. \href{https://doi.org/10.1080/10511482.2026.2649483}{How Does Upzoning Impact Residential Mobility Among Low Income Households? Evidence from New York City.} \emph{Housing Policy Debate}. 1-21.
  % exact: submitted=  accepted=  online=  print=
\item[2026] \tab{}\textbf{Song, T.} \&  Reid, C. \href{https://www.tandfonline.com/doi/full/10.1080/01944363.2026.2618647}{The Implications of Naturally Occurring Affordable Housing (NOAH) Sales for Residential Mobility.} \emph{Journal of the American Planning Association}, 92(3), 360-374.
  % exact: submitted=  accepted=  online=  print=
...
\begin{subpoints}
  \spitem \textbf{Song, T.} What Counts as a Demolition and Redevelopment? Local Permit and Parcel Data Infrastructure and Measurement Choices.
  \spitem \textbf{Song, T.} How Does Suburban Housing Supply Shape Asian American Segregation?
  \spitem \textbf{Song, T.} Immigration, Housing Markets, and Ethnic Divergence in Asian American Homeownership, 2000--2019.
\end{subpoints}
...
\begin{subpoints}
  \spitem \textbf{School of Public and International Affairs} — Instructor of Record
    \begin{subpoints2}
      \spitem UAP 5494: Advanced Quantitative Techniques for Urban Research \term{2026F}
    \end{subpoints2}
\end{subpoints}
...
\begin{subpoints}
  ...
  \spitem \textbf{D-Lab} — Workshop (Assistant) Instructor
    \begin{subpoints2}
      \spitem \textbf{R:} Fundamentals \term{2024F, 2025F}; Data Wrangling \term{2025F}; Data Visualization \term{2025S}; Geospatial Fundamentals \term{2024F, 2025F}; Census Fundamentals \term{2025S, 2026S}; SQL Fundamentals \term{2025S, 2026S}; AI-assisted Coding \term{2025F}
      ...
      \spitem \textbf{Git:} Git Fundamentals \term{2026S}
    \end{subpoints2}
\end{subpoints}
...
% ===== Conferences =====
\section{Conferences}
\textsc{AAG} -- American Association of Geographers;\quad
\textsc{ACSP} -- Association of Collegiate Schools of Planning;\quad
\textsc{APPAM} -- Association for Public Policy Analysis and Management;\quad
\textsc{UAA} -- Urban Affairs Association

\subsection{Conference Panels Organized}
\begin{tablist}
  \item[2026] \tab{} Housing Supply and Redevelopment: When Do Policies Improve Affordability and Access?. \emph{ACSP}, Pittsburgh, PA. Oct. (Scheduled)
...
\begin{tablist}
    \item[2026] \tab{}\textbf{Song, T.} What Housing Demolition Becomes: Redevelopment and Neighborhood Context in Washington, DC.
    \emph{ACSP}, Pittsburgh, PA. Oct. (Scheduled)

    \item[2026] \tab{}\textbf{Song, T.} What Housing Demolition Becomes: Redevelopment and Neighborhood Context in Washington, DC.
    \emph{UAA}, Chicago, IL. May. 1

\item[2026] \tab{}\textbf{Song, T.} How Does Housing Supply Shape Asian American Segregation?  
    \emph{AAG}, San Francisco, CA. Mar. 18
  
  \item[2025] \tab{}\textbf{Song, T.} How Does Housing Supply Shape Asian American Segregation?  
    \emph{APPAM}, Seattle, WA. Nov. 15

  \item[2025] \tab{}\textbf{Song, T.} How Does Housing Supply Shape Asian American Segregation?  
    \emph{ACSP}, Minneapolis, MN. Oct. 23
...
\begin{tablist}
  \item[2025] \tab{}The Promise and Pitfalls of Commercial Microdata for Planning Research. Ramiller, A., Chapple, K., Greenlee, A. \& \textbf{Song, T.}, Xu, W. \emph{ACSP}, Minneapolis, MN. Oct. 24
\end{tablist}
...
\begin{tablist}
  \item[2025] \tab{}Global Metropolitan Studies Program. "Beyond the Black-White Binary: Immigration and Segregation in Asian America." Nov. 21
...
\subsection{Virginia Tech}
\begin{tablist}
  \item[2026--] \tab{}Faculty Coordinator, Urban Planning Analytics (UPA) Certificate Program, School of Public and International Affairs
\end{tablist}
...
\emph{Housing Policy Debate (3)} & \emph{Housing, Theory and Society (2)}\\
...
\begin{tablist}
  \item[2024–26] \tab{}Volunteer, \href{https://asiansarestrong.org/}{Asians Are Strong}, San Francisco, CA, USA
