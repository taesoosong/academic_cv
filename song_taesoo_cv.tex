...
\begin{document}
    ...
    \begin{tablist}
      ...
      \begin{itemize}
        ...
        \vspace{-0.6em}
        \item {\textbf{Awarded Russell Sage Foundation Dissertation Research Grant (2025)}}
      \end{itemize}
...
\end{tabular}
    ...
    %    \item Reid, C. \& \textbf{Song, T.} "Does Apartment Flipping Fuel Residential Displacement? Insights from Assessor and Mobility Data." (Submitted)
    % \end{itemize}
...
\begin{itemize}
  \setlength{\itemsep}{-0.0em}  % Adjusts spacing between items
  \item "Anti-immigration and the Politics of Housing Affordability: Examining the Evolution and Housing Market Impacts of Foreign Buyer Taxes in British Columbia and Ontario." \textbf{Song, T.} (Under review at \emph{Journal of Urban Affairs)}
  \item "The Implications of Naturally Occurring Affordable Housing (NOAH) Sales for Residential Mobility." Reid, C. \& \textbf{Song, T.} (Under review at \emph{Journal of American Planning Association})
  \item "How Does Upzoning Impact Residential Mobility Among Low-Income Households? Evidence from New York City." Davis, J., \textbf{Song, T.} \& Chapple, K. (Under review at \emph{Housing Policy Debate})
...
\begin{itemize}
  ...
  \item "How Does Suburban Housing Supply Shape Asian American Segregation?" \textbf{Song, T.}
    \begin{itemize}
      ...
      \item[•] \emph{ACSP}, Minneapolis, MN. October, 2025 (Scheduled)
    \end{itemize}
...
\begin{tablist}
  \item[2025] \tab{}"The Promise and Pitfalls of Commercial Microdata for Planning Research." Ramiller, A., Chapple, K., Greenlee, A. \& \textbf{Song, T.}, Xu, W. \emph{ACSP}, Minneapolis, MN. October (Scheduled)
\end{tablist}
 ...
 \section*{Teaching}
    ...
    \textbf{City and Regional Planning  (Instructor)}\\[0.7em]
    U.S. Housing, Planning, and Policy (2024Su)\\
    - Overall effectiveness rating: 6.70/7.00 (department average: 6.27)\\[0.5em]
   ...
   \textbf{Underwood International College (Teaching Assistant)}\\[0.7em]
    World History: Group II (2019S)\\
    World History: Group I  (2018F, 2019S)\\[0.7em]
  \textbf{Urban Planning and Engineering (Teaching Assistant)}\\[0.7em]
  ...
  \subsection*{Reviewer}
    \begin{tabular}{@{}p{0.47\textwidth} p{0.47\textwidth}@{}}
      ...
      Housing Policy Debate & Humanities and Social Sciences Communications\\
      Regional Studies & Urban Sustainability
    \end{tabular}
