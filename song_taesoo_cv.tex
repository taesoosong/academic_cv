...
\setlist[tablist]{leftmargin=\listtabwidth,labelsep=0.6em,labelindent=0pt,
  itemsep=\listitemspace,parsep=0pt,topsep=0pt,partopsep=0pt,font=\normalfont}

% Dotless top-level items (Teaching depts; Conference paper titles; WIP papers)
\newlist{subpoints}{itemize}{1}
\setlist[subpoints]{label={},leftmargin=1.6em,
  itemsep=.55\baselineskip, parsep=0pt, partopsep=0pt,
  topsep=.50pt, after=\vspace{0.0\baselineskip}} % <-- space after list

% Dotless second-level details (courses; venues/dates)
\newlist{subpoints2}{itemize}{1}  
\setlist[subpoints2]{label={},leftmargin=2.6em,
  itemsep=.28\baselineskip, parsep=0pt, partopsep=0pt,
  topsep=.30\baselineskip, after=0pt}           % <-- space before list
