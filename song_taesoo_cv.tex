...
\begin{document}
    ...
    \begin{tablist}
      \item[2025] \tab{}\emph{Reid, C.} \& \textbf{Song, T.} Does Apartment Flipping Fuel Residential Displacement? Insights from Assessor and Mobility Data. \emph{53rd International Conference on Urban Affairs}, Vancouver, BC. Apr. (Scheduled)
