...
\begin{document}
    ...
    \begin{tablist}
      ...
      \begin{itemize}
        ...
        \vspace{-0.6em}
        \item {\footnotesize Committee: Carolina Reid, Karen Chapple (Co-chairs), Daniel Chatman, Irene Bloemraad}
        \item {\footnotesize \textbf{Awarded Russell Sage Foundation Dissertation Research Grant} (2025)}
      \end{itemize}
...
\section*{Awards and Honors}
 ...
 \section*{Teaching}
    ...
    \textbf{City and Regional Planning  (Instructor)}\\[0.6em]
   ...
   \textbf{Underwood International College (Teaching Assistant)}\\[0.6em]
    World History: Group II (2019 Spring)\\
    World History: Group I  (2018 Fall, 2019 Spring)\\[0.6em]
  \textbf{Urban Planning and Engineering (Teaching Assistant)}\\[0.6em]
