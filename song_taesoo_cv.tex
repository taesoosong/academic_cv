...
% --- Page-break control for list items ---
\usepackage{needspace}

% --- Lists (clear separation + safe page breaks) ---
\usepackage{enumitem}
...
\setlist[subpoints]{%
  ...
  parsep=0pt,
  partopsep=0pt,
  % Keep each item from splitting awkwardly across pages; scope locally.
  before=\begingroup\let\olditem\item \renewcommand{\item}{\Needspace{3.2\baselineskip}\olditem},
  after=\endgroup \vspace{0.14\baselineskip}
}
...
\setlist[subpoints2]{%
  ...
  parsep=0pt,
  partopsep=0pt,
  before=\begingroup\let\olditem\item \renewcommand{\item}{\Needspace{2.4\baselineskip}\olditem},
  after=\endgroup
}

% Back-compat alias (if legacy content uses it)
