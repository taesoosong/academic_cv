...
\begin{itemize}
  \item[2025] Housing Policy, Neighborhood Change, and Residential Mobility: Novel Methodologies and Insights.
  \begin{itemize}
    \item \emph{53rd International Conference on Urban Affairs}, Vancouver, BC. Apr. (Scheduled)
  \end{itemize}
\end{itemize}

\subsection*{Conference Papers Presented\footnote{* if presented by other authors.}}

\noindent Davis, J., \textbf{Song, T.} \& Chapple, K. How Does Upzoning Impact Residential Mobility Among Low-Income Households? Evidence from New York City.
\begin{itemize}
  \item \emph{53rd International Conference on Urban Affairs}, Vancouver, BC. Apr. 2025 (Scheduled)
\end{itemize}

\noindent Reid, C. \& \textbf{Song, T.} Does Apartment Flipping Fuel Residential Displacement? Insights from Assessor and Mobility Data.
\begin{itemize}
  \item \emph{53rd International Conference on Urban Affairs}, Vancouver, BC. Apr. 2025 (Scheduled)
  \item \emph{The Association of Collegiate Schools of Planning 64th Annual Conference}, Seattle, WA. Nov. 17, 2024 (Scheduled)
\end{itemize}

\noindent \textbf{Song, T.} "Reassessing the Diversity of Asian American Housing Outcomes (2000-2020)."
\begin{itemize}
  \item \emph{The Association of Collegiate Schools of Planning 64th Annual Conference}, Seattle, WA. Nov. 19, 2024 (Scheduled)
\end{itemize}

\noindent Ramiller, A., \textbf{Song, T.}, Parker, M. \& Chapple, K. "Measuring Residential Mobility Using Consumer Reference Datasets."
\begin{itemize}
  \item \emph{The Association of Collegiate Schools of Planning 64th Annual Conference}, Seattle, WA. Nov. 18, 2024 (Scheduled)*
  \item \emph{52nd International Conference on Urban Affairs}, New York, NY. Apr. 26 *
\end{itemize}

\noindent \textbf{Song, T.} "Affordability for Whom? The Impacts of Foreign Buyer Taxes on British Columbia and Ontario Rental Housing Markets."
\begin{itemize}
  \item \emph{The Association of Collegiate Schools of Planning 63rd Annual Conference}, Chicago, IL. Oct. 21, 2023.
\end{itemize}

\noindent \textbf{Song, T.} \& Chapple, K. "Does Gentrification Constrain Housing Markets for Low-income Households? Evidence from Household Residential Mobility in the New York and San Francisco Metropolitan Areas."
\begin{itemize}
  \item \emph{52nd International Conference on Urban Affairs}, New York, NY. Apr. 26, 2024
  \item \emph{The Association of Collegiate Schools of Planning 62nd Annual Conference}, Toronto, ON. Nov. 5, 2022
\end{itemize}
