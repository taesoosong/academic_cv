...
\setlist[tablist]{%
  ...
  labelsep=0.6em,
  labelindent=0pt,
  itemsep=\dimexpr0.40\baselineskip\relax,
  parsep=0pt,
  topsep=0pt,
  partopsep=0pt,
  font=\normalfont
...
\setlist[subpoints]{%
  ...
  parsep=0pt, 
  partopsep=0pt,
  % ensure each \item has room; if not, push to next page
  before=\let\origItem\item\def\item{\needspace{4\baselineskip}\origItem},
...
\setlist[subpoints2]{%
  ...
  parsep=0pt, 
  partopsep=0pt,
  before=\let\origItem\item\def\item{\needspace{3\baselineskip}\origItem},
  after=\relax
}

% Back-compat alias (so existing \begin{subpoints1} ... works)
