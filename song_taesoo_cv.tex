...
\usepackage{multicol} % Include in your preamble
...
\begin{itemize}[leftmargin=*]
  \item Housing and Land Use Policy
  \item Residential Mobility and Neighborhood Change
  \item Immigration
  \item Asian American Studies
  \item Urban Data Analytics
\end{itemize}
\end{multicols}
