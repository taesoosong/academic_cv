...
\begin{itemize}
  ...
  \item "The Promise and Pitfalls of Commercial Microdata for Planning Research." Ramiller, A., Chapple, K., Greenlee, A. \& \textbf{Song, T.}
    \begin{itemize}
      \addtolength{\leftskip}{2em} 
      \setlength{\itemsep}{-0.4em}
      \item[•] \emph{ACSP}, Minneapolis, MN. October, 2025 (Scheduled)
...
\section*{Awards and Honors}
 ...
 \section*{Teaching}
    ...
    \textbf{City and Regional Planning  (Instructor)}\\[0.7em]
      ...
      Introduction to Urban Data Analytics (Summer 2023)\\[0.7em]
   ...
   \textbf{Underwood International College (Teaching Assistant)}\\[0.7em]
    ...
    World History: Group I  (2018 Fall, 2019 Spring)\\[0.7em]
