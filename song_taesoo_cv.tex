...
\begin{tablist}
  \item[2026--] \tab{}\textbf{Assistant Professor of Urban Analytics (Incoming), Virginia Tech}, 
  \emph{School of Public and International Affairs, Urban and Environmental Policy and Planning} \\
  \hspace*{1.8em} (starting August 2026)
\end{tablist}
...
\item[2026] \tab{}\textbf{Song, T.} How Does Housing Supply Shape Asian American Segregation?  
    \emph{AAG}, San Francisco, CA. Mar. 18 \term{scheduled}
...
\emph{Housing Policy Debate (2)} & \emph{Housing, Theory and Society}\\
...
{\footnotesize Last Updated: January 2026}
