...
\setlist[tablist]{leftmargin=\listtabwidth,labelsep=0.6em,labelindent=0pt,
  itemsep=.36\baselineskip, parsep=0pt, topsep=0pt, partopsep=0pt, font=\normalfont}
...
\setlist[subpoints]{label={}, leftmargin=1.7em,
  itemsep=.42\baselineskip, parsep=0pt, partopsep=0pt,
  topsep=0pt, after=\vspace{.18\baselineskip}} % space after the block

\newlist{subpoints1}{itemize}{1}
\setlist[subpoints1]{label={}, leftmargin=1.7em,
  itemsep=.42\baselineskip, parsep=0pt, partopsep=0pt,
  topsep=0pt, after=\vspace{.18\baselineskip}}

% Dotless second-level details (courses; venues/dates)
\newlist{subpoints2}{itemize}{1}
\setlist[subpoints2]{label={}, leftmargin=2.7em,
  itemsep=.24\baselineskip, parsep=0pt, partopsep=0pt,
  topsep=.14\baselineskip, after=0pt}           % space before this block
