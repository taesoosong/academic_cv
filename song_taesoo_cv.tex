...
% Lists (ONE source of truth for spacing)
\usepackage{enumitem}
\newcommand{\listitemspace}{0.25em}
\setlist[itemize]{leftmargin=1.2em,itemsep=\listitemspace,parsep=0pt,topsep=0pt,partopsep=0pt}
...
% Dotless hanging sublists (two depths)
\newenvironment{subpoints}{%
  \begin{itemize}[label={},leftmargin=1.4em]}{\end{itemize}}
\newenvironment{subpoints2}{%
  \begin{itemize}[label={},leftmargin=2.4em]}{\end{itemize}}
...
% Headings (knobs for spacing; thin rule tight to title)
\usepackage{titlesec}
\SetTracking{encoding=*, family=\sfdefault}{30}
\newcommand{\beforesectionskip}{1.15\baselineskip}  % space before title
\newcommand{\aftersectionskip}{0pt}                  % space after title
\newcommand{\ruleaboveskip}{-0.20\baselineskip}      % title→rule gap (negative = tighter)
...
\titleformat*{\subsection}{\sffamily\bfseries\fontsize{11}{13}\selectfont}
