...
\begin{document}
    ...
    \begin{tablist}
        ...
        \tab{}Davis, J., \textbf{Song, T.} \& Chapple, K. "How Does Upzoning Impact Residential Mobility Among Low-Income Households? Evidence from New York City." (In Progress)\\
        \tab{}Reid, C. \& \textbf{Song, T.} "Does Apartment Flipping Fuel Residential Displacement? Insights from Assessor and Mobility Data." (In Progress)\\
    \end{tablist}
