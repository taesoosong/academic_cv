...
% Lists & tabbed descriptions
\usepackage{enumitem}
\newcommand{\listitemspace}{0.25em}
\setlist[itemize]{leftmargin=1em,itemsep=\listitemspace,parsep=\listitemspace,topsep=0pt,partopsep=0pt}
...
% Headings (more space before title; tighter rule gap)
\usepackage{titlesec}
\SetTracking{encoding=*, family=\sfdefault}{30}
\newcommand{\SectionRule}{\vspace{-0.10\baselineskip}\noindent\rule{\linewidth}{0.5pt}}
\titleformat{\section}
  {\sffamily\bfseries\scshape\fontsize{14.4}{16.5}\selectfont}
  {}{0pt}{\MakeUppercase}
  [\SectionRule]
\titlespacing{\section}{0pt}{1.10\baselineskip}{0pt}
\titleformat{\subsection}
  {\sffamily\bfseries\fontsize{11}{13}\selectfont}
  {}{0pt}{}
\titleformat*{\subsection}{\sffamily\bfseries\fontsize{11}{13}\selectfont} % starred form same style
...
% Approach A: dotless hanging lines (two depths)
...
\newenvironment{subpoints2}{%
  \begin{itemize}[label={},leftmargin=2.4em,itemsep=0.12\baselineskip,parsep=0pt,topsep=0pt]}%
  {\end{itemize}}
...
\begin{subpoints}
  \item City and Regional Planning — Instructor of Record
    \begin{subpoints2}
    ...
    \end{subpoints2}
  \item D Lab — Workshop Instructor and Assistant Instructor
    \begin{subpoints2}
...
\begin{subpoints}
  \item Underwood International College — Teaching Assistant
    \begin{subpoints2}
      \item World History Group II \term{2019S}
      \item World History Group I \term{2018F, 2019S}
    \end{subpoints2}
  \item Urban Planning and Engineering — Teaching Assistant
    \begin{subpoints2}
