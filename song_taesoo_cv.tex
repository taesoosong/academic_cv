...
\begin{document}
    ...
    \begin{tablist}
      ...
      \begin{itemize}
        \item Dissertation: Rethinking ‘Asian’ in Housing: Ethnic and Immigration in Asian American Homeownership
        \vspace{-0.6em}
    ...
    \subsection*{Under Review}
        \textbf{Song, T.} "Affordability for Whom? The Impacts of Foreign Buyer Taxes on British Columbia and Ontario Rental Housing Markets." Revised and resubmitted at \emph{Housing Studies}.
    \subsection*{Peer-reviewed Journal Articles}
    \begin{tablist}
        \item[2024] \tab{}Ramiller A., \textbf{Song, T.}, Parker, M. \& Chapple, K. \href{https://www.huduser.gov/portal/periodicals/cityscape/vol26num3/article12.html}{"Residential Mobility and Big Data: Assessing the Validity of Consumer Reference Datasets."} \emph{Cityscape 26}(3), 227-239.
...
\section*{Grants and Fellowship}
    ...
    \subsection*{Internal}
    \begin{tablist}
        \item[2024-] \tab{}Data Science Fellowship, D-Lab, UC Berkeley (\$2,400)
