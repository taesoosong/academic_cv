...
\begin{document}
    ...
    \begin{tablist}
      ...
      \begin{itemize}
        \item Dissertation: Policy, Planning, and the Dynamics of Asian American Housing Exclusion and Segregation (Awarded Russell Sage Foundation Dissertation Research Grant, 2025)
        \vspace{-0.6em}
...
\begin{itemize}
  ...
  \item "Anti-immigration and the Politics of Housing Affordability: Examining the Evolution and Housing Market Impacts of Foreign Buyer Taxes in British Columbia and Ontario." \textbf{Song, T.} (Under revision at \emph{Journal of Urban Affairs)}
  \item "The Implications of Naturally Occurring Affordable Housing (NOAH) Sales for Residential Mobility." Reid, C. \& \textbf{Song, T.} (Under revision at \emph{Journal of American Planning Association})
...
\end{tablist}
 ...
 \section*{Teaching}
    ...
    \textbf{D-Lab (Instructor, Assistant Instructor)}\\[0.7em]
    % \vspace{-0.5em}
    \textbf{R:} Fundamentals (2024F), Data Visualization (2025S), Geospatial (2024F), Census  (2025S), SQL (2025S) Fundamentals Workshops\\[0.5em]
    \textbf{Python:} Geospatial (2025S), Machine Learning (2025S) Fundamentals Workshops\\[0.5em]
