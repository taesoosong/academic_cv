...
\setlist[tablist]{leftmargin=\listtabwidth,labelsep=0.6em,labelindent=0pt,
  itemsep=.38\baselineskip, parsep=0pt, topsep=0pt, partopsep=0pt, font=\normalfont}

% One-indent blocks (e.g., PH.D. details; depts; paper titles)
\setlist[subpoints]{label={}, leftmargin=1.7em,
  topsep=.22\baselineskip,       % space before the first subpoint
  itemsep=.40\baselineskip,      % spacing between subpoints
  after=\vspace{.14\baselineskip},
  parsep=0pt, partopsep=0pt}

% One-indent block
\newlist{subpoints1}{itemize}{1}
\setlist[subpoints1]{label={}, leftmargin=1.7em,
  topsep=.22\baselineskip,        % gap from degree line → first subpoint
  itemsep=.40\baselineskip,       % between subpoints
  after=\vspace{.14\baselineskip},% space after the block
  parsep=0pt, partopsep=0pt}

% Two-indent block (for reference)
\setlist[subpoints2]{label={}, leftmargin=2.7em,
  topsep=.16\baselineskip, itemsep=.26\baselineskip,
  after=0pt, parsep=0pt, partopsep=0pt}
...
% Headings (more before; zero after; tight rule)
\usepackage{titlesec}
...
% ===== Education =====
\section{Education}
\begin{tablist}[itemsep=.45\baselineskip] % more space between degrees
