...
\begin{tablist}
  \item[2026--] \tab{}\textbf{Assistant Professor, Virginia Tech}, starting August 2026
    \begin{subpoints}
      \spitem School of Public and International Affairs, Urban and Environmental Policy and Planning
    \end{subpoints}
\end{tablist}
...
\begin{tablist}
  \item[] \tab{}\textbf{Song, T.} What Housing Demolition Becomes: Redevelopment and Neighborhood Context in Washington, DC.
  \item[] \tab{}\textbf{Song, T.} How Does Suburban Housing Supply Shape Asian American Segregation?
  \item[] \tab{}\textbf{Song, T.} Immigration, Housing Markets, and Ethnic Divergence in Asian American Homeownership, 2000--2019.
  \item[] \tab{}\textbf{Song, T.} Who Gets In, and on What Terms? Land Use Regimes and the Divergent Making of Asian American Suburbia.
\end{tablist}
