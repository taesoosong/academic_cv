...
% For 1st-level dotless subpoints
\setlist[subpoints]{%
  label={}, leftmargin=1.7em,
  topsep=\dimexpr0.22\baselineskip\relax,
  itemsep=\dimexpr0.42\baselineskip\relax,
  parsep=0pt, partopsep=0pt,
  before=\let\orig@item\item\def\item{\needspace{4\baselineskip}\orig@item},
  after=\vspace{\dimexpr0.14\baselineskip\relax}
}

% For 2nd-level dotless subpoints
\setlist[subpoints2]{%
  label={}, leftmargin=2.7em,
  topsep=\dimexpr0.18\baselineskip\relax,
  itemsep=\dimexpr0.28\baselineskip\relax,
  parsep=0pt, partopsep=0pt,
  before=\let\orig@item\item\def\item{\needspace{3\baselineskip}\orig@item},
  after=\relax
}
