...
% Inline “subpoints” with same spacing as your list
\newenvironment{inlinesubpoints}{%
  \par\vspace{0.22\baselineskip}% topsep
  \begingroup
    \setlength{\parindent}{0pt}%
    \setlength{\parskip}{0.42\baselineskip}% itemsep
}{%
  \par\endgroup
}
...
\setlist[subpoints2]{%
  ...
  itemsep=0.28\baselineskip,
  parsep=0pt,
  partopsep=0pt,
  before=\Needspace{2.8\baselineskip} % avoid orphaned first subitem
}
...
\begin{inlinesubpoints}
\textbf{Song, T.} Anti-immigration and the Politics of Housing Affordability: Examining the Evolution and Housing Market Impacts of Foreign Buyer Taxes in British Columbia and Ontario. Conditionally accepted at \emph{Journal of Urban Affairs}.
Reid, C., \& \textbf{Song, T.} The Implications of NOAH Sales for Residential Mobility. Invited to revise and resubmit at \emph{JAPA}.
Davis, J., \textbf{Song, T.}, \& Chapple, K. How Does Upzoning Impact Residential Mobility Among Low-Income Households? Evidence from New York City. Invited to revise and resubmit at \emph{Housing Policy Debate}.
\textbf{Song, T.} Immigration, Housing Markets, and Ethnic Divergence in Asian American Homeownership, 2000–2019. Under review at \emph{Housing Studies}.
\end{inlinesubpoints}
...
\begin{subpoints}
  \spitem \textbf{Song, T.} How Does Suburban Housing Supply Shape Asian American Segregation?
    \begin{subpoints2}
      \spitem \emph{ACSP}, Minneapolis, MN. Oct. 23, 2025 \term{scheduled}
      \spitem \emph{APPAM}, Seattle, WA. Nov. 15, 2025 \term{scheduled}
    \end{subpoints2}

  \spitem Davis, J., \textbf{Song, T.}, \& Chapple, K. How Does Upzoning Impact Residential Mobility Among Low-Income Households? Evidence from New York City.
    \begin{subpoints2}
      \spitem \emph{UAA}, Vancouver, BC. Apr. 17, 2025*
    \end{subpoints2}

  \spitem Reid, C., \& \textbf{Song, T.} Does Apartment Flipping Fuel Residential Displacement? Insights from Assessor and Mobility Data.
    \begin{subpoints2}
      \spitem \emph{ACSP}, Seattle, WA. Nov. 18, 2024
    \end{subpoints2}

  \spitem \textbf{Song, T.} Reassessing the Heterogeneity of Asian American Housing Outcomes, 2000–2019.
    \begin{subpoints2}
      \spitem \emph{ACSP}, Seattle, WA. Nov. 19, 2024
    \end{subpoints2}

  \spitem Ramiller, A., \textbf{Song, T.}, Parker, M., \& Chapple, K. Measuring Residential Mobility Using Consumer Reference Datasets.
    \begin{subpoints2}
      \spitem \emph{ACSP}, Seattle, WA. Nov. 18, 2024*
      \spitem \emph{UAA}, New York, NY. Apr. 26, 2024*
    \end{subpoints2}

  \spitem \textbf{Song, T.} Affordability for Whom? The Impacts of Foreign Buyer Taxes on British Columbia and Ontario Rental Housing Markets.
    \begin{subpoints2}
      \spitem \emph{ACSP}, Chicago, IL. Oct. 21, 2023
    \end{subpoints2}

  \spitem \textbf{Song, T.}, \& Chapple, K. Does Gentrification Constrain Housing Markets for Low-Income Households? Evidence from Household Residential Mobility in the New York and San Francisco Metropolitan Areas.
    \begin{subpoints2}
      \spitem \emph{UAA}, New York, NY. Apr. 26, 2024
      \spitem \emph{ACSP}, Toronto, ON. Nov. 5, 2022
    \end{subpoints2}
\end{subpoints}
