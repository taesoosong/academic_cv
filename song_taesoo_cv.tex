...
\item "Anti-immigration and the Politics of Housing Affordability: Examining the Evolution and Housing Market Impacts of Foreign Buyer Taxes in British Columbia and Ontario." \textbf{Song, T.} (Revise & resubmit at \emph{Journal of Urban Affairs})
\item "The Implications of Naturally Occurring Affordable Housing (NOAH) Sales for Residential Mobility." Reid, C. & \textbf{Song, T.} (Under revision at \emph{Journal of the American Planning Association})
\item "How Does Upzoning Impact Residential Mobility Among Low-Income Households? Evidence from New York City." Davis, J., \textbf{Song, T.} & Chapple, K. (Under revision at \emph{Housing Policy Debate})
\end{itemize}
...
\item "How Do Ethnic, Immigration, and Generational Differences Shape Fragmented Housing Experiences Among Asian Americans in the San Francisco Bay Area?" \textbf{Song, T.}
\end{itemize}
