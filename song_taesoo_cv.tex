...
\setlist[tablist]{leftmargin=\listtabwidth,labelsep=0.6em,labelindent=0pt,
  itemsep=\dimexpr0.38\baselineskip\relax, parsep=0pt, topsep=0pt, partopsep=0pt,
  font=\normalfont}

% One-indent (e.g., Designated Emphasis; Teaching departments; Paper titles)
...
% Two-indent (e.g., courses; venues/dates)
\newlist{subpoints2}{itemize}{1}
\setlist[subpoints2]{label={}, leftmargin=2.7em,
  topsep=\dimexpr0.16\baselineskip\relax,
  itemsep=\dimexpr0.26\baselineskip\relax,
  parsep=0pt, partopsep=0pt,
  after=0pt}
