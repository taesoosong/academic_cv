...
\begin{document}
    ...
    \begin{tablist}
      \item[2021-] \tab{}\textbf{Ph.D. in City and Regional Planning, University of California, Berkeley}, USA
      ...
      \end{itemize}
      \item[2017-2019] \tab{}\textbf{M.S. in Urban Planning and Engineering, Yonsei University}, Seoul, South Korea
      \begin{itemize}
        \item Thesis: Three Essays on the Impact of Community Contextual Characteristics on Resident Perceptions
    \end{itemize}
      \item[2012-2017] \tab{}\textbf{B.A. in Economics, Yonsei University Underwood Int'l College}, Seoul, South Korea
      \begin{itemize}
    ...
    \subsection*{In Progress}
        \textbf{Song, T.} "Affordability for Whom? The Impacts of Foreign Buyer Taxes on British Columbia and Ontario Rental Housing Markets." Submitted to a journal.
