...
% Lists (unified, readable spacing)
\usepackage{enumitem}
\newcommand{\listitemspace}{0.25em}
% For label+content rows (Education, Grants, etc.)
...
% Headings (spacing knobs; tight rule under title)
\usepackage{titlesec}
\SetTracking{encoding=*, family=\sfdefault}{30}
\newcommand{\beforesectionskip}{1.25\baselineskip}  % more space before title
\newcommand{\aftersectionskip}{0pt}                  % none after title
\newcommand{\ruleaboveskip}{-0.28\baselineskip}      % tighter title→rule
