...
\end{tablist}
  ...
  \subsection*{Reviewer}
    \begin{tabular}{@{}p{0.47\textwidth} p{0.47\textwidth}@{}}
      ...
      \emph{Housing Policy Debate & Housing}, \emph{Theory and Society}\\
  ...
  \subsection*{Volunteering}
    \begin{tablist}
        \item[2024-] \tab{}Volunteer, \href{https://asiansarestrong.org/}{Asians Are Strong}, San Francisco, CA, USA
        \item[2024-] \tab{}Volunteer, Community Safety Buddies Oakland, Oakland, CA, USA
    \end{tablist}
