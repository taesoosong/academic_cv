...
\begin{document}
    ...
    \begin{tablist}
        \item[In Press] \tab{}\textbf{Song, T.} \& Chapple, K. "Does Gentrification Constrain Housing Markets for Low-income Households? Evidence from Household Residential Mobility in the New York and San Francisco Metropolitan Areas." \emph{Urban Studies}.
...
\section*{Awards}
  ...
  \subsection*{Reviewer}
    ...
    \begin{tablist}
        ...
        % \item[2023-Present] \tab{}Policy Reporter, \href{si.re.kr}{\textbf{Seoul Institute}}, Seoul, South Korea
