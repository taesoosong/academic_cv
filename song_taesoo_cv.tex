...
% ------- Encoding, language, micro-typography -------
\usepackage[T1]{fontenc}
\usepackage[USenglish]{babel}
\usepackage{microtype}

% ------- Fonts -------
\usepackage{ebgaramond}   % serif
\usepackage{tgheros}      % sans for headings

% ------- Layout -------
\usepackage[margin=0.7in]{geometry}
\usepackage{setspace}
\setstretch{1.00}         % readable body leading

% ------- Lists and tabbed descriptions -------
\usepackage{enumitem}
\newcommand{\listitemspace}{0.25em}

% bulletless itemize for compact detail lines
...
% tabbed description list for year or degree labels
\usepackage{tabto}
\usepackage{tabularx}
...
\newcommand{\SectionRule}{\vspace{0.2\baselineskip}\titlerule[0.6pt]\vspace{0.15\baselineskip}}
...
% ------- Bibliography (optional, if you cite) -------
\usepackage[maxcitenames=6,minnames=3]{biblatex}
\addbibresource{biblio.bib}

% ------- Author name bolding in bibliography entries (if used) -------
\usepackage{xstring}
\usepackage{etoolbox}
\newboolean{bold}
...
% \printbibliography  % if you need references section
