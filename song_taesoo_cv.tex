...
\subsection*{Conference Papers Presented\footnote{Denoted * if presented by other authors.}}

\begin{itemize}
  \setlength{\itemsep}{-0.0em}  % Adjusts spacing between items
  
  \item \hangindent=0.6em \hangafter=1 Davis, J., \textbf{Song, T.} \& Chapple, K. "How Does Upzoning Impact Residential Mobility Among Low-Income Households? Evidence from New York City."
    \begin{itemize}
  ...
  \item \hangindent=0.6em \hangafter=1 Reid, C. \& \textbf{Song, T.} "Does Apartment Flipping Fuel Residential Displacement? Insights from Assessor and Mobility Data."
    \begin{itemize}
      \addtolength{\leftskip}{2em} 
      \setlength{\itemsep}{-0.4em}
      \item[•] \emph{UAA}, Vancouver, BC. Apr. 2025 (Scheduled)
      \item[•] \emph{ACSP}, Seattle, WA. Nov. 17, 2024 (Scheduled)*
    \end{itemize}

  \item \hangindent=0.6em \hangafter=1 \textbf{Song, T.} "Reassessing the Diversity of Asian American Housing Outcomes (2000-2020)."
    \begin{itemize}
      \addtolength{\leftskip}{2em} 
      \setlength{\itemsep}{-0.4em}
      \item[•] \emph{ACSP}, Seattle, WA. Nov. 19, 2024 (Scheduled)
    \end{itemize}

  \item \hangindent=0.6em \hangafter=1 Ramiller, A., \textbf{Song, T.}, Parker, M. \& Chapple, K. "Measuring Residential Mobility Using Consumer Reference Datasets."
  \begin{itemize}
      \addtolength{\leftskip}{2em} 
      \setlength{\itemsep}{-0.4em}
      \item[•] \emph{ACSP}, Seattle, WA. Nov. 18, 2024 (Scheduled)*
      \item[•] \emph{UAA}, New York, NY. Apr. 26, 2024*
  \end{itemize}

  \item \hangindent=0.6em \hangafter=1 \textbf{Song, T.} "Affordability for Whom? The Impacts of Foreign Buyer Taxes on British Columbia and Ontario Rental Housing Markets."
  \begin{itemize}
      \addtolength{\leftskip}{2em} 
      \setlength{\itemsep}{-0.4em}
  ...
  \item \hangindent=0.6em \hangafter=1 \textbf{Song, T.} \& Chapple, K. "Does Gentrification Constrain Housing Markets for Low-income Households? Evidence from Household Residential Mobility in the New York and San Francisco Metropolitan Areas."
  \begin{itemize}
      \addtolength{\leftskip}{2em} 
      \setlength{\itemsep}{-0.4em}
      \item[•] \emph{UAA}, New York, NY. Apr. 26, 2024
