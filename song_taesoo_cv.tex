...
\begin{itemize}
  \setlength{\itemsep}{-0.6em}  % Adjusts spacing between items
  \small  % Sets font size to smaller (10pt)
  ...
  \item \textbf{Song, T.} "Reassessing the Diversity of Asian American Housing Outcomes (2000-2020)."
    \begin{itemize}
      \setlength{\itemsep}{-0.4em}
