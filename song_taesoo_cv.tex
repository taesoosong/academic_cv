...
\hypersetup{
    ...
    citecolor   = marineblue2,
    linkcolor   = marineblue2,
    pdfauthor   = {\myname},
  ...
  % }
    ...
    \end{itemize}
      ...
      \begin{itemize}
        ...
        \vspace{-0.5em}
        \item Military Service: English Translator (Sergeant) at Korea Defence Intellligence Command (Apr. 2013-Jan. 2015)
    \end{itemize}
    \end{tablist}
...
\section*{Awards}
  ...
  \subsection*{Membership}
    ...
    \begin{tablist}
        \item[2023-Present] \tab{}Graduate Student Researcher at \href{https://ternercenter.berkeley.edu/}{\textbf{Terner Center for Housing Innovation}}, CA, USA
        \item[2023-Present] \tab{}Policy Reporter at \href{si.re.kr}{\textbf{Seoul Institute}}, Seoul, South Korea
        \item[2021-2023] \tab{}Graduate Student Researcher at \href{https://www.urbandisplacement.org/}{\textbf{Urban Displacement Project}}, CA, USA
        \item[2019-2021] \tab{}Researcher at \href{si.re.kr}{\textbf{Seoul Institute}}, Seoul, South Korea
    \end{tablist}
