...
\renewcommand{\thefootnote}{\fnsymbol{footnote}} % put in preamble

% Headings
\usepackage{titlesec}
\SetTracking{encoding=*, family=\sfdefault}{30}
\newcommand{\SectionRule}{%
  \vspace{0.2\baselineskip}\noindent\rule{\linewidth}{0.6pt}\vspace{0.15\baselineskip}}
\titleformat{\section}{\sffamily\bfseries\Large\scshape}{}{0pt}{\MakeUppercase}[\SectionRule]
...
% The rule MUST be here, not in the preamble
